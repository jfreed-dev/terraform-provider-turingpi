// Package kubeconfig provides utilities for working with Kubernetes kubeconfig files.
package kubeconfig
...
// Validate checks if a kubeconfig is valid and can connect to the cluster
